...
function attemptPullProdImage(): boolean {
...
function ensureDevImageExists(): boolean {
...
function runCommandInDocker(args: string[], useDevImage: boolean): void {
  ...
  try {
    ...
    container.on('exit', (code: number | null) => {
      if (code !== null && code !== 0) {
